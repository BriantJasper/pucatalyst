...
interface CertRequirement {
    id: string;
    type: "video" | "course" | "article" | "practice" | "exam";
    title: string;
    description: string;
    url?: string;
    duration: string;
...
// Generate sample requirements based on certification name
    ...
    const requirements: CertRequirement[] = [
        {
            id: "1",
            type: "video",
            title: `${certName} Overview`,
            description: `Watch an introduction video about ${certName} certification and what it covers.`,
        ...
        },
        {
            id: "2",
            type: "course",
            title: `${certName} Preparation Course`,
            description: `Complete a comprehensive preparation course for ${certName}.`,
        ...
        },
        {
            id: "3",
            type: "article",
            title: `${certName} Study Guide`,
            description: `Read the official study guide and documentation for ${certName}.`,
            url: `https://www.google.com/search?q=${encodeURIComponent(
                certName + " study guide"
            )}`,
            duration: "2-3 hours",
            completed: false,
        },
        {
            id: "4",
            type: "practice",
            title: `Practice Exams for ${certName}`,
            description: `Take practice exams to prepare for the official certification test.`,
            url: `https://www.google.com/search?q=${encodeURIComponent(
                certName + " practice exam"
            )}`,
            duration: "3-5 hours",
            completed: false,
        },
        {
            id: "5",
            type: "exam",
            title: `Official ${certName} Certification Exam`,
            description: `Register and take the official certification exam from ${provider}.`,
            url: `https://www.google.com/search?q=${encodeURIComponent(
                certName + " official certification " + provider
            )}`,
            duration: "1-2 hours",
            completed: false,
        },
...
const typeColors: Record<string, string> = {
    ...
    exam: "text-emerald-400 bg-emerald-500/10",
};

export const CertDetailsModal = ({
    cert,
    isOpen,
    onClose,
    onStatusChange,
}: CertDetailsModalProps) => {
    const [requirements, setRequirements] = useState<CertRequirement[]>(() =>
        generateRequirements(cert.name, cert.provider)
    );
